...
export const Wallet = () => {
  ...
  const [destinationContactId, setDestinationContactId] = React.useState({});
  ...
  const addTransaction = () => {
    Meteor.call(
      "transactions.insert",
      {
        ...
        destinationContactId: destinationContactId?._id || "",
            ...
            {isTransferring && (
              <div className="mt-2">
                <SelectContact
                  ...
                  contacts={contacts}
                  contact={destinationContactId}
                  setContact={setDestinationContactId}
                />
              </div>
            )}
